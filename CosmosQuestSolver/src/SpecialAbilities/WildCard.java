...
//used by Tetra
public class WildCard extends SpecialAbility{
    ...
    */
    ...
    public void preRoundAction(Formation thisFormation, Formation enemyFormation){
        ...
        attackType = (int)(Formation.getTurnSeed(seed,Formation.STALEMATE_CUTOFF_POINT-1-turn) % 6);//change?
    }
    ...
    public String getDescription() {
        return "After attacking, attacks front units, splitting damage amonst them randomly";
    }
